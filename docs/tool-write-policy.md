...
- Chỉ HTTP 2xx ngoài 202, không có lỗi ứng dụng/transport, được ghi thành công. Lỗi, timeout, 202 hoặc mất tiến trình giữ trạng thái chưa rõ. Không tự retry. Action có thao tác executing/uncertain của cùng actor/workspace bị chặn gửi intent mới.
