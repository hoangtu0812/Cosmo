...
export type Tool = {
  ...
  auth_type: 'none' | 'bearer' | 'header' | 'oauth2' | 'oauth2_user';
...
export type Message = {suggestions?: string[]; is_pending?: boolean; id: string; conversation_id: string; role: 'user' | 'assistant'; content: string; model?: string; citations?: Citation[]; tool_calls?: MessageToolCall[]; attachments?: Attachment[]; usage?: ChatUsage; created_at: string};
