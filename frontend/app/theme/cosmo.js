...
/**
 * cosmo theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { cosmoTheme } from './cosmo';
 *   import './cosmo.css';
 */
export const cosmoTheme = {
  ...
  tokens: {
    ...
    "--font-family-body": "\"Noto Sans\", system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, Helvetica, Arial, sans-serif",
    "--font-family-heading": "\"Noto Sans\", system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, Helvetica, Arial, sans-serif",
    ...
    "--color-accent": "light-dark(#0074e2, #6d9cfe)",
    "--color-accent-muted": "light-dark(#eaf2fd, #6d9cfe26)",
    ...
    "--color-text-accent": "light-dark(#00458c, #c7d3ff)",
    ...
    "--color-icon-accent": "light-dark(#00458c, #c7d3ff)",
